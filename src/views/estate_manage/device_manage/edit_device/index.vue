      ...
      <el-row :gutter="32">
       ...
       <el-row :gutter="32">
        <el-col :span="12" :xs="24">
         ...
         <el-col :span="11" :xs="24" class="u-margin-6">
...
" prop="equipmentCode">
            <el-input clearable v-model.trim="reqData.equipmentCode" disabled></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="32">
...
export default {
  ...
  data() {
    return {
      ...
      dialogRules: {
        ...
        rankId: [{ required: true, message: "请输入名称", trigger: "blur" }]
      },
      marketSearch: [],
      role: false
    };
  ...
  created() {
    this.getEditData(this.$route.params.equipmentCode);
  ...
  methods: {
    ...
    getEditData(params) {
      this.$http
        .get(ApiSetting.estateDevice, { params: { equipmentCode: params } })
        .then(res => {
          if (res && res.data) {
            if (res.code == 0) {
              this.reqData = keysFilter(res.data[0], true, [
                "rankId",
                "rankName",
                "rankSecId",
                "rankSecName",
