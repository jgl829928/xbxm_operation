...
var default2dTheme = {
    ...
    pubPointImg: {
        "11001": System.imgPath+"/LongEscalator.png",   //长扶梯
        "11002": System.imgPath+"/escalator.png",   //扶梯
        "11003": System.imgPath+"/escalatorTwo.png",   //双扶梯
        "11004": System.imgPath+"/shortEscalator.png",   //矮扶梯
        "31001": System.imgPath+"/toilet.png",   //厕所
        "41001": System.imgPath+"/empty.png",   //空的填充
        "51001": System.imgPath+"/circle.png",   //圆
        "51002": System.imgPath+"/doubleCircle.png",   //双圆
        "21001": System.imgPath+"/lift.png"   //电梯
    }
}
...
IndoorMapLoader.prototype.load = function ( dataText, callback, texturePath ) {
    var scope = this;
    this.onLoadStart();
    this.loadAjaxJSON( this, dataText, callback );


};

IndoorMapLoader.prototype.loadAjaxJSON = function ( context, dataText, callback, callbackProgress ) {
  var result = context.parse( dataText );
  // console.log(result)
  callback( result );
